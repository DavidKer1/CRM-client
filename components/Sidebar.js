	...
	return (
		<>
			<aside className="bg-gray-700 sm:w-1/3 xl:w-1/5 sm:min-h-screen p-5">
				<div className="">
					<p className="text-white text-2xl text-2xl font-semibold">
						CRM Clientes
					</p>
				</div>
				<nav className="mt-5 list-none ">
					...
					<li
						className={
							router.pathname === "/pedidos" ? "bg-blue-900 p-2" : "p-2"
						}
					>
						<Link href="/pedidos">
					...
					<li
						className={
							router.pathname === "/productos" ? "bg-blue-900 p-2" : "p-2"
						}
					>
						<Link href="/productos">
				...
				<div className="">
					<p className="text-white text-2xl mt-10 text-2xl font-semibold">
						Otras opciones
					</p>
				</div>
				<nav className="mt-5 list-none ">
					<li
						className={
							router.pathname === "/mejoresvendedores" ? "bg-blue-900 p-2" : "p-2"
						}
					>
					...
					<li
						className={
							router.pathname === "/mejoresclientes" ? "bg-blue-900 p-2" : "p-2"
						}
					>
